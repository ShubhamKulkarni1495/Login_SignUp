...
if choose == 1:
    ...
    print(name)
    pas=input("enter your password (password should contain Upper,Small Letter, Special Character and number)=")
    u,l,d,s=0,0,0,0
    for check in pas:
        if (check.isupper()):
            u+=1
    ...
    if (l>=1 and u>=1 and s>=1 and d>=1 and l+s+u+d==len(pas)):
        ...
        print("At least password should contain one Special number or one digit")
